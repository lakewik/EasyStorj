...
class ClientConfigurationUI(QtGui.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.client_configuration_ui.bridge_request_timeout.\
            setMinimum(MINIMAL_ALLOWED_BRIDGE_REQUEST_TIMEOUT)

        self.client_configuration_ui.\
            bridge_request_timeout.setValue(DEFAULT_MAX_BRIDGE_REQUEST_TIMEOUT)
