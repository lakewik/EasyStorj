...
class Configuration:
    ...
    def __init__(self, sameFileNamePrompt=None, sameFileHashPrompt=None,
        ...
        if load_config:
            ...
            try:
                ...
                logger.debug('Error in Configuration init')
    ...
    def paint_config_to_ui(self, settings_ui):
        try:
            ...
            logger.debug('Error in Configuration paint config to ui')
            logger.error('Unspecified XML parse error')
            logger.error(e)
    ...
    def max_shard_size(self):
        ...
        try:
            ...
            logger.debug('Error in Configuration max_shard_size')
            logger.error('Unspecified XML parse error')
            logger.error(e)
    ...
    def get_max_bridge_request_timeout(self):
        ...
        try:
            ...
            logger.debug('Error in Configuration get_max_bridge_request_timeout')
            logger.error('Unspecified XML parse error')
            logger.error(e)
    ...
    def get_bridge_api_url(self):
        ...
        try:
            ...
            logger.debug('Error in Configuration get_bridge_api_url')
