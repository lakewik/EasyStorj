...
class Ui_FileMirrorsList(object):
    def setupUi(self, FileMirrorsList):
        ...
        FileMirrorsList.resize(1252, 591)
        ...
        self.open_established_mirrors_geodistribution_window_bt = QtGui.QPushButton(FileMirrorsList)
        self.open_established_mirrors_geodistribution_window_bt.setGeometry(QtCore.QRect(10, 490, 611, 31))
        self.open_established_mirrors_geodistribution_window_bt.setObjectName(_fromUtf8("open_established_mirrors_geodistribution_window_bt"))
        ...
        self.quit_bt.setGeometry(QtCore.QRect(10, 550, 1231, 31))
        self.quit_bt.setObjectName(_fromUtf8("quit_bt"))
        self.line_4 = QtGui.QFrame(FileMirrorsList)
        self.line_4.setGeometry(QtCore.QRect(10, 520, 1231, 31))
        self.line_4.setFrameShape(QtGui.QFrame.HLine)
        self.line_4.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_4.setObjectName(_fromUtf8("line_4"))
        self.open_available_mirrors_geodistribution_window_bt = QtGui.QPushButton(FileMirrorsList)
        self.open_available_mirrors_geodistribution_window_bt.setGeometry(QtCore.QRect(630, 490, 611, 31))
        self.open_available_mirrors_geodistribution_window_bt.setObjectName(_fromUtf8("open_available_mirrors_geodistribution_window_bt"))
    ...
    def retranslateUi(self, FileMirrorsList):
        ...
        self.open_established_mirrors_geodistribution_window_bt.setText(_translate("FileMirrorsList", "Show geodistribution of established mirrors", None))
        ...
        self.open_available_mirrors_geodistribution_window_bt.setText(_translate("FileMirrorsList", "Show geodistribution of available mirrors", None))
