...
class Ui_NodeDetails(object):
    def setupUi(self, NodeDetails):
        ...
        self.address_label.setGeometry(QtCore.QRect(210, 200, 171, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lato"))
        font.setPointSize(11)
        font.setBold(True)
...
"}"))
    ...
    def retranslateUi(self, NodeDetails):
        ...
        self.ping_label.setText(_translate("NodeDetails", "<html><head/><body><p><span style=\" color:#2683ff;\">12MS</span></p></body></html>", None))
