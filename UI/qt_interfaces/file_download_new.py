...
""))
        ...
        self.label_15.setGeometry(QtCore.QRect(450, 250, 181, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lato"))
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.uploaded_shards.setGeometry(QtCore.QRect(640, 250, 321, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lato"))
        font.setPointSize(11)
        font.setBold(True)
...
""))
        ...
        self.avg_bandwidth.setGeometry(QtCore.QRect(130, 250, 281, 16))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lato"))
        font.setPointSize(11)
        font.setBold(True)
