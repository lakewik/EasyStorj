...
"}"))
        ...
        self.label_3.setPixmap(QtGui.QPixmap(_fromUtf8("/home/lakewik/PycharmProjects/storjguibeta/4/storj-gui-client/UI/qt_interfaces/storj-logo-horizontal.png")))
...
"}"))
        ...
        self.bucket_select_combo_box.setGeometry(QtCore.QRect(15, 90, 331, 31))
...
"}"))
        ...
        self.edit_bucket_bt.setGeometry(QtCore.QRect(415, 90, 96, 31))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lato"))
        font.setPointSize(12)
        font.setBold(True)
...
"}"))
        ...
        self.settings_bt.setGeometry(QtCore.QRect(480, 10, 21, 21))
        self.settings_bt.setText(_fromUtf8(""))
        self.settings_bt.setPixmap(QtGui.QPixmap(_fromUtf8("cog-outline-filled.png")))
