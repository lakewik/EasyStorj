    ...
    def initialize_node_details(self):
        ...
        try:
            ...
            self.node_details_ui.last_timeout_label.setText(
               str(self.node_details_content.lastTimeout).replace('Z', '').replace('T', ' ') )  # get last timeout
            ...
            self.node_details_ui.last_seen_label.setText(
                str(self.node_details_content.lastSeen).replace('Z', '').replace('T', ' '))  # get last seen
