...
class MnemonicGeneratedUI(QtGui.QMainWindow):
    ...
    def __init__(self, parent=None, enter_mnemonic_ui=None):
        ...
        self.mnemonic_generated_ui.generate_new_key.clicked.connect(self.generate_new_mnemonic)
        ...
        self.mnemonic_generated_ui.mnemonic_edit.setPlainText(generated_mnemonic_key)
    ...
    def finish(self):
        self.enter_mnemonic_ui.encryption_mnemonic_key.setText(self.mnemonic_generated_ui.mnemonic_edit.toPlainText())
        self.close()
        return True
